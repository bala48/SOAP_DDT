...
:SET_BUNDLED_JAVA
set JAVA=C:\Program Files (x86)\Java\jdk1.8.0_144\bin\java
...
set CLASSPATH=%SOAPUI_HOME%soapui-5.4.0.jar;%SOAPUI_HOME%\ext\*;%SOAPUI_HOME%..\lib\*
...
set JAVA_OPTS=-Xms128m -Xmx1024m -XX:MinHeapFreeRatio=20 -XX:MaxHeapFreeRatio=40 -Dsoapui.properties="%SOAPUI_HOME%..\ESB\global.properties" "-Dsoapui.home=%SOAPUI_HOME%\" -splash:SoapUI-Spashscreen.png
